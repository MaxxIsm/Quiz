...
<template>
  <div class="ctr">
    <transition name="fade" mode="out-in">
      <questions
        v-if="questAnswered < questions.length"
        :questions="questions"
        :questAnswered="questAnswered"
        @quest-clicked="questIsAnswered"
      />
      <result :results="results" :totalRes="totalRes" v-else />
    </transition>
